...
class BasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create basis" do
    assert_difference('Base.count') do
      post bases_url, params: { basis: { code: @basis.code, email: @basis.email, level: @basis.level, use: @basis.use } }
    end
  ...
  test "should update basis" do
    patch basis_url(@basis), params: { basis: { code: @basis.code, email: @basis.email, level: @basis.level, use: @basis.use } }
