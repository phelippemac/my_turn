...
class SettingsTest < ApplicationSystemTestCase
  ...
  test "creating a Setting" do
    ...
    fill_in "Initial period", with: @setting.initial_period
    fill_in "Interval", with: @setting.interval
    fill_in "Last period", with: @setting.last_period
    fill_in "Max usage", with: @setting.max_usage
